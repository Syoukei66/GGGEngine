...
public:
  GG_INLINE void SetValue(T value)
  {
    this->value_ = value;
  }
  GG_INLINE T GetValue() const
  {
    return this->value_;
  }
...
public:
  GG_INLINE void SetValue(const T& value)
  {
    this->value_ = value;
  }
  GG_INLINE const T& GetValue() const
  {
    return this->value_;
  }
...
public:
  GG_INLINE void SetValue(const SharedRef<const T>& value)
  {
    this->value_ = value;
  }
  GG_INLINE SharedRef<const T> GetValue() const
  {
    return this->value_;
  }
