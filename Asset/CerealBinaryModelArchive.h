...
//void serialize(Archive& archive, StaticModelMeshData& data)
//{
//  archive(data.vertex_count_);
//  archive(data.vertex_format_);
//
//  //position
//  if (data.vertex_format_ & StaticModelMeshData::V_ELEM_POSITION)
//  {
...
//
//  //normal
//  if (data.vertex_format_ & StaticModelMeshData::V_ELEM_NORMAL)
//  {
...
//
//  //uv
//  if (data.vertex_format_ & StaticModelMeshData::V_ELEM_UV)
//  {
...
//
//  //uv2
//  if (data.vertex_format_ & StaticModelMeshData::V_ELEM_UV2)
//  {
...
//
//  //uv3
//  if (data.vertex_format_ & StaticModelMeshData::V_ELEM_UV3)
//  {
...
//
//  //uv4
//  if (data.vertex_format_ & StaticModelMeshData::V_ELEM_UV4)
//  {
...
//
//  //tangent
//  if (data.vertex_format_ & StaticModelMeshData::V_ELEM_TANGENT)
//  {
...
//
//  //color
//  if (data.vertex_format_ & StaticModelMeshData::V_ELEM_COLOR)
//  {
...
//=============================================================================
//template <class Archive>
//void serialize(Archive& archive, StaticModelNodeData& data)
//{
//  archive(
//    data.translation_,
//    data.scaling_,
...
//  {
//    SAFE_NEW(data.children_, StaticModelNodeData*[data.child_count_]);
//    for (T_UINT32 i = 0; i < data.child_count_; ++i)
//    {
//      SAFE_NEW(data.children_[i], StaticModelNodeData);
...
////=============================================================================
//template <class Archive>
//void serialize(Archive& archive, StaticModelData& data)
//{
//  archive(data.vertex_format_);
//  archive(data.vertex_size_);
//
//  archive(data.vertex_count_);
//  if (data.vertex_count_ > 0)
//  {
//    SAFE_NEW(data.vertices_, T_FLOAT[data.vertex_count_]);
//    archive(cereal::binary_data(data.vertices_, sizeof(T_FLOAT) * data.vertex_count_));
//  }
//
//  archive(data.polygon_count_);
//
//  archive(data.index_count_);
//  if (data.index_count_ > 0)
//  {
...
//  if (data.submesh_count_ > 0)
//  {
//    SAFE_NEW(data.submesh_index_counts_, T_UINT32[data.submesh_count_]);
//    archive(cereal::binary_data(data.submesh_index_counts_, sizeof(T_UINT32) * data.submesh_count_));
//  }
//
//  archive(data.bounds_);
//
//  archive(data.material_count_);
//  if (data.material_count_ > 0)
//  {
//    SAFE_NEW(data.materials_, ModelMaterialData*[data.material_count_]);
//    for (T_UINT32 i = 0; i < data.material_count_; ++i)
//    {
