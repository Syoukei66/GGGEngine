...
//  GG_INLINE T_FLOAT CalcValueByProgress(T_FLOAT min, T_FLOAT max, T_FLOAT progress) const
//  {
//    return min + (max - min) * progress;
//  }
//  GG_INLINE T_FLOAT CalcScaleBySize(Particle* particle, T_FLOAT size) const
//  {
//    return size / particle->GetSpriteRenderer()->GetWidth();
//  }
//
//public:
//  rcTextureRegion* region_;
//
//  T_FLOAT duration;
//  T_FLOAT life_time;
