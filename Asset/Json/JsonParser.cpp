...
// JsonParser
//=============================================================================
GG_INLINE static bool EndOfFile(char c)
{
  return c == '\0';
}
GG_INLINE static bool Escape(char c)
{
  return c == '\n' || c == '\t' || c == ' ';
}
GG_INLINE static bool IsStringBracket(char c)
{
  return c == '\"';
}
GG_INLINE static bool IsNumberBegin(char c)
{
  return ('0' <= c && c <= '9') || c == '.' || c == '-';
}
GG_INLINE static bool IsComma(char c)
{
  return c == ',';
}
GG_INLINE static bool IsValueSeparator(char c)
{
  return c == ':';
}
GG_INLINE static bool IsListBracketLeft(char c)
{
  return c == '[';
}
GG_INLINE static bool IsListBracketRight(char c)
{
  return c == ']';
}
GG_INLINE static bool IsMapBracketLeft(char c)
{
  return c == '{';
}
GG_INLINE static bool IsMapBracketRight(char c)
{
  return c == '}';
}
...
static std::string ParseString(const char** p, T_UINT8 depth)
{
  ...
  GG_ASSERT(false, "JsonParser::ParseString() : 予期せぬEOFが検出されました。");
  return ret;
}
...
static JsonBase* ParseValue(const char** p, T_UINT8 depth)
{
  ...
  GG_ASSERT(false, "JsonParser::ParseValue() : 予期せぬEOFが検出されました。");
  return nullptr;
}
...
static JsonString* ParseJsonString(const char** p, T_UINT8 depth)
{
  ...
  GG_ASSERT(false, "JsonParser::ParseJsonString() : 予期せぬEOFが検出されました。");
  return nullptr;
}
...
static JsonValue* ParseJsonValue(const char** p, T_UINT8 depth)
{
  ...
  GG_ASSERT(false, "JsonParser::ParseJsonValue() : 予期せぬEOFが検出されました。");
  return nullptr;
}
...
static JsonNode* ParseJsonMap(const char** p, T_UINT8 depth)
{
  ...
  GG_ASSERT(false, "JsonParser::ParseJsonMap() : 予期せぬEOFが検出されました。");
  return ret;
}
...
static JsonList<JsonBase>* ParseJsonList(const char** p, T_UINT8 depth)
{
  ...
  GG_ASSERT(false, "JsonParser::ParseJsonList() : 予期せぬEOFが検出されました。");
  return ret;
}
