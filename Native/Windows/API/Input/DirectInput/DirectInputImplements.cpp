#include "DirectInputImplements.h"
#include <XInput.h>
#include <WinUser.h>
...
static DirectInputDevice_KeyBoard::KeyboardInput KEYBOARD_INPUTS[DX_INPUT_DATANUM + 4] =
{
  { Digital::ID_A, 0 },
  { Digital::ID_B, 0 },
  { Digital::ID_X, 0 },
...
static const DirectInputDevice_XInput::XInputInput XINPUT_INPUTS[XINPUT_INPUT_MAX] =
{
...
static const DirectInputDevice_Mouse::MouseInput MOUSE_INPUTS[MOUSE_INPUT_MAX] =
{
  { Digital::ID_S3, DirectInputDevice_Mouse::MOUSE_RGB_BUTTON_LEFT },
  { Digital::ID_S4, DirectInputDevice_Mouse::MOUSE_RGB_BUTTON_CENTER },
