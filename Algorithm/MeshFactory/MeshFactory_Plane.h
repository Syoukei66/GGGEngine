...
//
GG_INLINE MeshData* Create(T_UINT32 format, T_FLOAT scale_x, T_FLOAT scale_y, T_UINT32 resolution_x, T_UINT32 resolution_y)
{
  return Create(format, scale_x, scale_y, resolution_x, resolution_y, (T_FLOAT)resolution_x, (T_FLOAT)resolution_y);
}
//
GG_INLINE MeshData* Create(T_UINT32 format, T_FLOAT scale_x, T_FLOAT scale_y)
{
