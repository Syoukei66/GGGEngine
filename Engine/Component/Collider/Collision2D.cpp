...
static T_FLOAT Dot(T_FLOAT ax, T_FLOAT ay, T_FLOAT bx, T_FLOAT by)
{
  return ax * bx + ay * by;
}

static T_FLOAT Cross(T_FLOAT ax, T_FLOAT ay, T_FLOAT bx, T_FLOAT by)
{
  return ax * by - ay * bx;
}
...
bool Line(T_FLOAT ax1, T_FLOAT ay1, T_FLOAT ax2, T_FLOAT ay2, T_FLOAT bx1, T_FLOAT by1, T_FLOAT bx2, T_FLOAT by2)
{
  ...
  const T_FLOAT outer_a_b = Cross(adx, ady, bdx, bdy);
  ...
  const T_FLOAT outer_v1_a = Cross(v1dx, v1dy, adx, ady);
  const T_FLOAT outer_v1_b = Cross(v1dx, v1dy, bdx, bdy);
...
bool Line_Circle(T_FLOAT ax1, T_FLOAT ay1, T_FLOAT ax2, T_FLOAT ay2, T_FLOAT bx, T_FLOAT by, T_FLOAT br)
{
  ...
  const T_FLOAT inner = Dot(pq.x, pq.y, pm.x, pm.y);
