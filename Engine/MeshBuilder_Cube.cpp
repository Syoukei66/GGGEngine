...
MeshBuilder_Cube::MeshBuilder_Cube(T_UINT32 format, T_FLOAT scale_x, T_FLOAT scale_y, T_FLOAT scale_z, T_UINT32 resolution_x, T_UINT32 resolution_y, T_UINT32 resolution_z, T_FLOAT tile_count_x, T_FLOAT tile_count_y, T_FLOAT tile_count_z, bool readonly)
  : format(format)
  , scale_x(scale_x)
  , scale_y(scale_y)
  , scale_z(scale_z)
...
Mesh* MeshBuilder_Cube::Create() const
{
