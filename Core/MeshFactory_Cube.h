...
//
inline MeshData* Create(T_UINT32 format, const TVec3f& scale)
{
  return Create(format, scale.x, scale.y, scale.z);
}
//
inline MeshData* Create(T_UINT32 format, const TVec3f& scale, const TVec3i& resolution)
{
  return Create(format, scale.x, scale.y, scale.z, resolution.x, resolution.y, resolution.z);
}
//
inline MeshData* Create(T_UINT32 format, const TVec3f& scale, const TVec3i& resolution, const TVec3f& tile_count)
{
