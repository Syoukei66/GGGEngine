...
enum VertexAttribute
{
  ...
  // 16bit Compression Format
  V_ATTR_16_BIT_COMPRESSED_POSITION = 1 << 9,
  V_ATTR_16_BIT_COMPRESSED_NORMAL = 1 << 10,
  V_ATTR_16_BIT_COMPRESSED_UV = 1 << 11,
  V_ATTR_16_BIT_COMPRESSED_TANGENT = 1 << 12,
  V_ATTR_16_BIT_COMPRESSED_BONE_WEIGHTS = 1 << 13,

  // 8bit Compression Format
  V_ATTR_8_BIT_COMPRESSED_POSITION = 1 << 9,
  V_ATTR_8_BIT_COMPRESSED_NORMAL = 1 << 10,
  V_ATTR_8_BIT_COMPRESSED_UV = 1 << 11,
  V_ATTR_8_BIT_COMPRESSED_TANGENT = 1 << 12,
  V_ATTR_8_BIT_COMPRESSED_BONE_WEIGHTS = 1 << 13,
};
