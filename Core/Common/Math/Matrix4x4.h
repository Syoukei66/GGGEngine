...
public:
  ...
  // =================================================================
public:
  static GG_INLINE Matrix4x4 Frustum(T_FLOAT left, T_FLOAT right, T_FLOAT bottom, T_FLOAT top, T_FLOAT z_near, T_FLOAT z_far);
  ...
  static GG_INLINE Matrix4x4 Perspective(T_FLOAT fov, T_FLOAT aspect, T_FLOAT z_near, T_FLOAT z_far);
  static GG_INLINE Matrix4x4 LookAt(const TVec3f& eye, const TVec3f& at, const TVec3f& up);
  static GG_INLINE Matrix4x4 TRS(const TranslationMatrix& t, const Quaternion& r, const ScalingMatrix& s);
